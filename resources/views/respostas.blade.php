...
<div class="row" style="overflow-x: hidden; overflow-y: scroll; white-space: nowrap;">
    <div class="col-md-12">
...
<div class="row" style="overflow-x: hidden; overflow-y: scroll; white-space: nowrap;">
    <div class="col-md-12">
        ...
        <div class="card border-info">
            <div class="card-header bg-default text-center">
                <a title="Exportar caixas" id="csv_origem" download="respostas.xls" href="#" onclick="return ExcellentExport.excel(this, 'tabela2', 'Sheet Name Here');" class="btn btn-success"> <i class="fas fa-file-excel"></i> <span id="txtcx2">Exportar</span> <i class="fas fa-file-excel"></i></a>
            </div>
            <div class="card-body">

                <div class="table-responsive">

                    <table class="table table-condensed table-striped table-hover table-sm table-bordered" id="tabela2" style="white-space: pre-wrap;">
                        <thead>
                            <tr>
                                <th class="quebra">Data</th>
                                <th class="quebra">Email</th>
